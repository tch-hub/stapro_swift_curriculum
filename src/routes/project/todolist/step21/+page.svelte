...
<div class="container mx-auto px-4 py-8">
	...
	<div class="space-y-8">
		...
		<div>
			...
			<p class="mb-4">
				`HomeView`にある右下の「＋」ボタンは、他の画面でも使いたくなるかもしれません。これを再利用可能な部品として切り出しましょう。`Components`フォルダに`FloatingActionButton.swift`という名前で新しいSwiftUI
				Viewファイルを作成します。
			</p>
			<CodeBlock
...
`}
		...
		<div>
			...
			<ul class="list-inside list-disc space-y-2 rounded-md bg-base-200 p-4">
