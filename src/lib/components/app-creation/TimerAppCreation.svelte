<script>
	...
	import { timerSteps } from '$lib/data/app-creation/index';
...
<div class="container mx-auto max-w-5xl px-4 py-8">
				...
				<div class="flex flex-col gap-8 lg:flex-row lg:items-start">
					<div class="flex-1">
						...
						<p class="mb-6 leading-relaxed">
							このアプリ制作では、SwiftUIを使ってタイマーアプリを作成します。以下の機能を学習できます：
						</p>
	...
	<section class="mb-16 hidden">
		<!-- Hiding appCreation structure for now as it takes space and might be redundant with code samples? Or keep it? The user wanted less scrolling.
...
└── Components/
	...
	<section class="mb-16">
		...
		<AppCreationSteps steps={timerSteps} projectId="timer" />
	</section>
